...
int filledPolygonRGBAMTPoint(SDL_Renderer* renderer, const Sint16** vx, const Sint16** vy, int n, Uint8 r, Uint8 g, Uint8 b, Uint8 a, int** polyInts, int* polyAllocated)
{
	int result;
	int i;
	int y, xa, xb;
...
int filledPolygonRGBAPointer(SDL_Renderer* renderer, Sint16** vx, Sint16** vy, int n, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
